...
exports.main = function(args, callback) {
    ...
    function callJsdoc() {
        ...
        var cmd = "\"" + nodePath + "\" \"" + require.resolve("@textile/jsdoc/jsdoc.js") + "\" -c \"" + path.join(basedir, "lib", "tsd-jsdoc.json") + "\" -q \"module=" + encodeURIComponent(moduleName) + "&comments=" + Boolean(argv.comments) + "\" " + files.map(function(file) { return "\"" + file + "\""; }).join(" ");
